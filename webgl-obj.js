...
// from https://webglfundamentals.org/webgl/webgl-load-obj-w-vertex-colors.html
...
function parseOBJ(text) {
    ...
    /*
    divide each line into three groups:
    - the first group contains the first word (i.e. the keyboard)
    - the second group contains the whitespace between the keyword and the rest of the line
    - the third group contains the rest of the line (i.e. the arguments)
     */
    const keywordRE = /(\w*)(?: )*(.*)/;
    ...
    for (let lineNo = 0; lineNo < lines.length; ++lineNo) {
        ...
        const [, keyword, unparsedArgs] = m; // the first element is the full match (not needed)
